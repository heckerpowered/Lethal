...
enum class TextureStorage {
     ...
     * the temporary storage available. A logical render pass followed by a logical resolve can
     * satisfy this requirement when the backend executes both within that same native scope.
