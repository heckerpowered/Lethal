...
object ParticleInterop {
    @JvmStatic
    fun particle(particle: VanillaParticle): EnumParticleTypes {
...
fun VanillaParticle.particle(): EnumParticleTypes {
    return ParticleInterop.particle(this)
}
