...
class BlockStateAccessViewTest {
    @Test
    ...
    fun supportedClassificationResolvesToTheOriginalBlockState() {
        ...
        assertSame(blockState, blockState.asView<BlockClassificationAccess>())
    }

    @Test
    fun unsupportedClassificationResolvesToNull() {
        val blockState: BlockStateAccess = OrdinaryBlockState

        assertNull(blockState as? BlockClassificationAccess)
    }
