...
class ItemStackInteropTest {
    @Test
    fun persistentDataRemainsAnIndependentCapability() {
        assertFalse(ItemStackAccess::class.java.isAssignableFrom(PersistentDataAccess::class.java))
    }
    ...
    fun supportedPersistentDataResolvesToTheOriginalStack() {
        ...
        assertSame(stack, ItemStackInterop.persistentData(stack))
    }

    @Test
    fun unsupportedPersistentDataResolvesToNull() {
        assertNull(ItemStackInterop.persistentData(OrdinaryStack))
    }
